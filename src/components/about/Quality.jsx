...
const Quality = () => {
  return (
    <div className="bg-[url('/src/assets/images/plan/desktop/bg-steps.png')] bg-no-repeat bg-center 
      bg-cover rounded-md mt-40 px-5 md:px-10 lg:px-20 py-10 flex flex-col gap-10 lg:py-20 md:flex-row-reverse"
    >
      ...
      <div className='text-center md:text-left md:w-[90%] lg:w-[60%] lg:pr-10'>
        ...
        <p className='text-[var(--color-primary)] mt-5'>Although we work with growers who pay close attention to all stages of harvest and processing, we employ, on our end, a rigorous quality control program to avoid over-roasting or baking the coffee dry. Every bag of coffee is tagged with a roast date and batch number. Our goal is to roast consistent, user-friendly coffee, so that brewing is easy and enjoyable.</p>
      </div>
    </div>
  )
}
