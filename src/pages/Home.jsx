...
const Home = () => {
  return (
    <div className='px-2 sm:px-5 md:px-10 lg:px-24'>
      <ScrollTop />
      <div className='hero my-20 py-28 px-3 flex flex-col gap-6 md:gap-8 lg:py-28 text-center rounded-md items-center sm:text-left sm:items-start sm:px-10 md:px-14 lg:px-20'>
